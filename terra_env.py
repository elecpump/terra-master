...
class TerraEnv:
    ...
    def __init__(self, port=17655, frames=6):
        ...
        if ping.get("version") not in ("0.4", "0.4.1") or ping.get("bridge") != "TerraBridge":
            raise ValueError("TerraEnv requires TerraBridge 0.4/0.4.1 with training profile validation")
